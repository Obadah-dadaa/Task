    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="PUT" action="{{ route('update',$profile->id) }}">
                    @csrf
                        <!-- Form Row-->
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" value="{{$profile->email}}">
                        </div>
                        <!-- Form Row-->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                ...
                                <input class="form-control" id="inputPhone" type="password" placeholder="Enter your password">
                        </div>
                        <!-- Save changes button-->
