    ...
    <div class="card p-4">
         <div class=" image d-flex flex-column justify-content-center align-items-center">
             <button class="btn btn-secondary"> <img src="https://i.imgur.com/wvxPV9S.png" height="100" width="100" /></button>
              ...
              <span class="idd">{{$user->email}}
            </span>

               <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">{{$user->phone}}
            </span>
                 ...
                 {{-- <div class=" mt-2"> --}}
                     <a class="btn btn-primary" href="{{route('edit_profile',Auth::user()->id)}}" style="text-decoration: none;
                        "> Edit Profile</a>
                 {{-- </div> --}}
                 ...
                 <div class="text mt-3"> <span>Eleanor Pena is a creator of minimalistic x bold graphics and digital artwork.<br><br> Artist/ Creative Director by Day #NFT minting@ with FND night. </span>
                  ...
                  <div class="gap-3 mt-3 icons d-flex flex-row justify-content-center align-items-center">
                   ...
                   <div class=" px-2 rounded mt-4 date "> <span class="join">Joined {{$user->created_at}}</span>
